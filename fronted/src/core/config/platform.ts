...
export const PLATFORMS: Record<string, PlatformConfig> = {
  ...
  csdn: {
    ...
    publish: {
      entryUrl: 'https://mp.csdn.net/mpblog/article/post',
      selectors: {
        title: 'input[placeholder*="标题"], .title-input',
        content: '.editor-body, [contenteditable="true"]',
        submit: '.publish-btn, button[class*="publish"]',
  ...
  juejin: {
    ...
    auth: {
      type: 'qrcode',
      loginUrl: 'https://juejin.cn/passport/login',
      checkLoginInterval: 1000,
      maxWaitTime: 120000,
    },
    publish: {
      entryUrl: 'https://juejin.cn/editor/draft',
      selectors: {
        title: 'input[placeholder*="标题"], .title-input',
        content: '.editor-body, [contenteditable="true"]',
        submit: '.publish-btn, button[class*="publish"]',
    ...
    limits: { titleLength: [5, 100], contentLength: [0, 100000], imageCount: 20 },
  },
}
